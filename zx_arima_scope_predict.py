...
np.save(f"output/ZX/analysis/inner_gts_{target_dim}_{iterm}_{prediction_step}_hour.npy", np.array(tts))
np.save(f"output/ZX/analysis/best_predict_{target_dim}_{iterm}_{prediction_step}_hour.npy", np.array(pres))
